...
public class DefaultVertexQuery extends VertexQueryBase implements VertexQuery {
    ...
    public Iterable<Vertex> vertices() {
        return new DefaultGraphQueryIterable<Vertex>(getParameters(), getSourceVertex().getVertices(Direction.BOTH, getParameters().getAuthorizations()), true, true, null);
    }

    @Override
    public Iterable<Edge> edges() {
        return new DefaultGraphQueryIterable<Edge>(getParameters(), getSourceVertex().getEdges(Direction.BOTH, getParameters().getAuthorizations()), true, true, null);
    }
