...
import org.securegraph.elasticsearch.ElasticSearchGraph;
import org.securegraph.elasticsearch.ElasticSearchGraphConfiguration;
...
public class TestHelpers {
    ...
    public static Graph createGraph() {
        ...
        ElasticSearchGraphConfiguration configuration = new ElasticSearchGraphConfiguration(config);
        return new ElasticSearchGraph(configuration, configuration.createIdGenerator(), configuration.createSearchIndex());
    }
