...
public class BabyNamesDataset {
    private static final Logger LOGGER = LoggerFactory.getLogger(BabyNamesDataset.class);

    public static void load(Graph graph, int numberOfVerticesToCreate, String[] visibilities, Authorizations authorizations) throws IOException {
